...
Для привязки к HTML элементам РЕКОМЕНДУЕТСЯ использовать html-классы с префиксом `js_`, например, `js_buy-button`, `js_discount-price`.
Для упрощения дальнейшего редактирования РЕКОМЕНДУЕТСЯ избегать привязки к одним и тем же html-классам поведения и представления (стилей).
...
<img src="http://habrastorage.org/files/c51/47c/f9d/c5147cf9dcb246b3817521258ab68f71.png"/>
