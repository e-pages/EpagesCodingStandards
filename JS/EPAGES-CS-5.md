...
Все переменные должны быть объявлены перед использованием. JavaScript не требует этого, но программу проще для читать. Так же легче будет обнаружить необъявленные переменные. Использование глобальных переменных должны быть сведены к минимуму.
