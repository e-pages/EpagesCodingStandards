...
<h3>2.5. Ключевые слова и True/False/Null</h3>
...
<h3>Пространства имён и оператор use</h3>
...
<h3>2.6. Классы, свойства и методы</h3>
Слово "класс" относится ко всем классам, интерфейсам и трейтам.

<h4>2.6.1 Extends и implements</h4>
...
<h4>2.6.5. `abstract`, `final` и `static`</h4>
...
<h4>2.6.6. Вызовы функций и методов</h4>
